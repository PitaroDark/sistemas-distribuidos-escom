...
public class HttpClientSynchronous {
  ...
  private static final String BUCKET_STRAY_ENRPOINT = "https://storage.googleapis.com/storage/v1/b/first_bucket_brandon/o/stray.jpg";
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    HttpRequest request = HttpRequest.newBuilder()
        .GET()
        .uri(URI.create(BUCKET_STRAY_ENRPOINT))
